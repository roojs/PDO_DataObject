...
introspect = new Roo.XComponent({
 ...
 _strings : {
  ...
  '772093dc200996fb9c83c590c31767e8' :"Instrospecting the database and table schema Information",
  ...
  _tree : function()
  {
   ...
   items  : [
    {
     xtype : 'Header',
     html : _this._strings['772093dc200996fb9c83c590c31767e8'] /* Instrospecting the database and table schema Information */,
     level : 1,
     xns : Roo.bootstrap,
     '|xns' : 'Roo.bootstrap'
    },
