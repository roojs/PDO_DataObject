...
getAttribute==[16] => pgsql
QUERY: SELECT schemaname || '.' || tablename AS "Name" FROM pg_catalog.pg_tables WHERE schemaname NOT IN ('pg_catalog', 'information_schema', 'pg_toast')  
getAttribute==[16] => pgsql
